# anchor-campus-map-section Specification

## Purpose
Define requirement untuk section Anchor Campus dengan map plate berotasi ultra-lambat, pin overlay tetap stabil, dan keterbacaan narasi yang aman lintas breakpoint serta preferensi motion.
